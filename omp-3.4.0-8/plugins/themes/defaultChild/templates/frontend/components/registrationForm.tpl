	...
	<div class="fields">
		<div class="given_name">
			<label>
				...
				<input type="text" class="form-control" name="givenName" autocomplete="given-name" id="givenName" value="{$givenName|default:""|escape}" maxlength="255" required aria-required="true">
			</label>
		</div>
		<div class="family_name">
			<label>
				...
				<input type="text" class="form-control" name="familyName" autocomplete="family-name" id="familyName" value="{$familyName|default:""|escape}" maxlength="255">
			</label>
		</div>
		<div class="affiliation">
			<label>
				...
				<input type="text" class="form-control" name="affiliation" autocomplete="organization" id="affiliation" value="{$affiliation|default:""|escape}" required aria-required="true">
			</label>
		</div>
		<div class="country">
			<label>
	...
	<div class="fields">
		<div class="email">
			<label>
				...
				<input type="email" class="form-control" name="email" id="email" value="{$email|default:""|escape}" maxlength="90" required aria-required="true" autocomplete="email">
			</label>
		</div>
		<div class="username">
			<label>
				...
				<input type="text" class="form-control" name="username" id="username" value="{$username|default:""|escape}" maxlength="32" required aria-required="true" autocomplete="username">
			</label>
		</div>
		<div class="password">
			<label>
