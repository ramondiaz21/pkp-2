<?php
/* Smarty version 4.3.1, created on 2025-02-20 12:00:17
  from 'app:frontendpagescatalog.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_67b76db1498755_56925088',
...
function content_67b76db1498755_56925088 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
        ...
        <pre>
            <?php echo print_r($_smarty_tpl->tpl_vars['categories']->value);?>
                ...
                <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['categories']->value)) {?>
            <div class="categories_section">
                <h2><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"catalog.categories"),$_smarty_tpl ) );?>
</h2>
                <ul>
                                        <?php
...
?>
                        <li>
                            <a href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>PKPApplication::ROUTE_PAGE,'page'=>"catalog",'op'=>"category",'path'=>$_smarty_tpl->tpl_vars['category']->value->getPath()),$_smarty_tpl ) );?>
">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <?php } else { ?>
                        <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"catalog.noCategories"),$_smarty_tpl ) );?>
</p>
        <?php }?>
