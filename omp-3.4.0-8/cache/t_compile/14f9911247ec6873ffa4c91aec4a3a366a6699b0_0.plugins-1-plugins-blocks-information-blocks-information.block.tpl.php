...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_67b7c46bf2a300_43539057',
...
function content_67b7c46bf2a300_43539057 (Smarty_Internal_Template $_smarty_tpl) {
	...
	<div class="content">
		<ul>
			<?php if (!empty($_smarty_tpl->tpl_vars['forReaders']->value)) {?>
				<li>
					<a href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>PKPApplication::ROUTE_PAGE,'page'=>"information",'op'=>"readers"),$_smarty_tpl ) );?>
">
			...
			<?php if (!empty($_smarty_tpl->tpl_vars['forAuthors']->value)) {?>
				<li>
					<a href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>PKPApplication::ROUTE_PAGE,'page'=>"information",'op'=>"authors"),$_smarty_tpl ) );?>
">
			...
			<?php if (!empty($_smarty_tpl->tpl_vars['forLibrarians']->value)) {?>
				<li>
					<a href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>PKPApplication::ROUTE_PAGE,'page'=>"information",'op'=>"librarians"),$_smarty_tpl ) );?>
">
