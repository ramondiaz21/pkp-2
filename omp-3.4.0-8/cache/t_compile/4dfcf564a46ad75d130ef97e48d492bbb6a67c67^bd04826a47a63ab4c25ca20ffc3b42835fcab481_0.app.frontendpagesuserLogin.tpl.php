<?php
/* Smarty version 4.3.1, created on 2025-02-20 18:11:02
  from 'app:frontendpagesuserLogin.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_67b7c496be1810_06888377',
...
function content_67b7c496be1810_06888377 (Smarty_Internal_Template $_smarty_tpl) {
...
/plugins/themes/defaultChild/images/library.jpg"
            width="580"
            height="123"
            alt="COSITEC"
    ...
    <fieldset class="fields">
        ...
        <div class="username">
            <label>
                ...
                <input class="form-control" type="text" name="username" id="username" value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( (($tmp = $_smarty_tpl->tpl_vars['username']->value ?? null)===null||$tmp==='' ? '' ?? null : $tmp) ));?>
" required aria-required="true" autocomplete="username">
        ...
        <div class="password">
            <label>
                ...
                <input class="form-control" type="password" name="password" id="password" value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( (($tmp = $_smarty_tpl->tpl_vars['password']->value ?? null)===null||$tmp==='' ? '' ?? null : $tmp) ));?>
